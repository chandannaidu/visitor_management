...
.round {
    ...
    <body>
        ...
        <h1 align="center" id="a">BUS LIST</h1>
        <a href="mainpage.jsp" class="previous round">&#8249;</a>
            <div id="pos">
            <a href="wofficelist.jsp" class="previous">&laquo; Previous</a>
            <a href="whouse.jsp" class="next">Next &raquo;</a>
            </div>
