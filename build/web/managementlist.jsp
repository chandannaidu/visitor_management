...
ResultSet resultSet = null; %> 
   <div id="dd">
    <table align="center" style="width:100%" border="3"> 
        <tr> </tr> 
        <tr bgcolor="gray"> 
            <td width="6%"><b>COMPANY NAME</b></td>
            <td width="8%"><b>AGENT NAME</b></td> 
            <td width="3%"><b>SEX</b></td> 
            <td width="20%"><b>PURPOSE OF VISIT</b></td>
             <td width="20%"><b>DETAIL'S</b></td>
    ...
    statement=connection.createStatement(); String sql ="SELECT * FROM marketing_agent";
    resultSet = statement.executeQuery(sql);
    while(resultSet.next())
{ %> <tr bgcolor="whitesmoke" color="black"> 
    <td><%=resultSet.getString("cmp_name") %></td>
    <td><%=resultSet.getString("agnt_name") %></td> 
