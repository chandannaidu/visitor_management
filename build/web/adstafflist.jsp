...
.round {
    ...
    <body>
        ...
        <a href="admin.jsp" class="previous round">&#8249;</a>
            <div id="pos">
            <a href="stafflisthouse.jsp" class="previous">&laquo; Previous</a>
            <a href="stafflistoffice.jsp" class="next">Next &raquo;</a>
            </div>
...
ResultSet resultSet = null; %> 
   <div id="dd">
    ...
    statement=connection.createStatement(); String sql ="SELECT * FROM adlectures";
