        ...
        function validate()
                 {    
                     ...
                     if(document.getElementById("txtEntryTime").value=="")
                     {
                         ...
                         document.getElementById("txtEntryTimeZ").focus();
                         return false;
                     }
...
<form name="new" onsubmit="return(validate());">
...
<table border='1' style="width:40%;"height=80%;">
 <tr>
  ...
  <td><LABEL for="staff_id">STAFF ID:<sup style="color:#F00">*</sup> </LABEL></td>
         ...
         <td><INPUT type="text" id="staff_id"></td>
 ...
 <tr>
  ...
  <td><LABEL for="dpt">department:<sup style="color:#F00">*</sup> </LABEL></td>
      ...
      <input type="checkbox" id="dpt" value="ECE">ECE<br/>
          <input type="checkbox" id="dpt" value="MECH">MECH<br/>
 ...
 <tr>
  ...
  <td><LABEL for="staff_name">STAFF NAME:<sup style="color:#F00">*</sup> </LABEL></td>
         ...
         <td><INPUT type="text" id="staff_name"></td>

 </tr>

 <tr>
  <td><LABEL for="ent_t"><INPUT type="button" onclick="fnSetEntryTime();" value="ENTRY TIME" id="ent_t"><sup style="color:#F00">*</sup> </LABEL><INPUT id="txtEntryTime" type="text"></td>
   <td><LABEL for="ent_t"><INPUT type="button" onclick="fnSetExitTime();"  value="EXIT TIME" id="ext_t"><sup style="color:#F00">*</sup> </LABEL><INPUT id="txtExitTime" type="text"></td>
 </tr>
