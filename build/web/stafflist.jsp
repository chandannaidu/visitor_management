...
.round {
    ...
    <body>
        ...
        <h1 align="center" id="a">LECTURERS LIST</h1>
        <a href="mainpage.jsp" class="previous round">&#8249;</a>
            <div id="pos">
            <a href="whouse.jsp" class="previous">&laquo; Previous</a>
            <a href="wofficelist.jsp" class="next">Next &raquo;</a>
            </div>
...
ResultSet resultSet = null; %> 
   <div id="dd">
    ...
    statement=connection.createStatement(); String sql ="SELECT * FROM lectures";
