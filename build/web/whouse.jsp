...
.round {
    ...
    <body>
        ...
        <h1 align="center" id="a">HOUSE LIST</h1>
        <a href="mainpage.jsp" class="previous round">&#8249;</a>
            <div id="pos">
            <a href="wbuslist.jsp" class="previous">&laquo; Previous</a>
...
ResultSet resultSet = null; %> 
   <div id="dd">
    ...
    statement=connection.createStatement(); String sql ="SELECT * FROM house";
