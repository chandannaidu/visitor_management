...
.round {
    ...
    <body>
        ...
        <h1 align="center" id="a">OFFICE LIST</h1>
        <a href="mainpage.jsp" class="previous round">&#8249;</a>
            <div id="pos">
            <a href="stafflist.jsp" class="previous">&laquo; Previous</a>
            <a href="wbuslist.jsp" class="next">Next &raquo;</a>
            </div>
...
ResultSet resultSet = null; %> 
   <div id="dd">
    ...
    statement=connection.createStatement(); String sql ="SELECT * FROM office";
