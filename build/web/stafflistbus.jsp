...
#dd{
    ...
    <body>
        ...
        <h1 align="center" id="a">BUS STAFF LIST</h1>
        <a href="admin.jsp" class="previous round">&#8249;</a>
            <div id="pos">
            <a href="stafflistoffice.jsp" class="previous">&laquo; Previous</a>
            <a href="stafflisthouse.jsp" class="next">Next &raquo;</a>
            </div>
        ...
        <tr bgcolor="gray"> 
            ...
            <td width="20%"><b>PHONE NO</b></td>
             <td width="8%"><b>BLOOD GROUP</b></td>
              <td width="8%"><b>BUS NUMBER</b></td>
        </tr> <%
            try{ connection = DriverManager.getConnection(connectionUrl+dbName, userId, password); 
    statement=connection.createStatement(); String sql ="SELECT * FROM adbus";
